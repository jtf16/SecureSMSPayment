...
import pt.ulisboa.ist.sirs.securesmsserver.data.loaders.ClientsLoader;
...
public class ClientsFragment extends Fragment
        implements LoaderManager.LoaderCallbacks<List<Client>> {
    ...
    public void onLoadFinished(Loader<List<Client>> loader, List<Client> data) {
        clientsAdapter.setClients(data);
    }
