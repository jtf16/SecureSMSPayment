...
import pt.ulisboa.ist.sirs.securesmsserver.data.loaders.ClientMovementsLoader;
...
public class MovementsFragment extends Fragment
        implements LoaderManager.LoaderCallbacks<List<ClientMovement>> {
     ...
     */
    @Override
    public Loader<List<ClientMovement>> onCreateLoader(int id, Bundle args) {
        return new ClientMovementsLoader(getActivity());
    }
     ...
     */
    @Override
    public void onLoadFinished(Loader<List<ClientMovement>> loader, List<ClientMovement> data) {
        movementAdapter.setClientMovements(data);
    }
     ...
     */
    @Override
    public void onLoaderReset(Loader<List<ClientMovement>> loader) {
