...
import pt.ulisboa.ist.sirs.securesmsserver.data.loaders.PhonesLoader;
...
public class PhonesFragment extends Fragment
        implements LoaderManager.LoaderCallbacks<List<Phone>> {
    ...
    public Loader<List<Phone>> onCreateLoader(int id, Bundle args) {
        return new PhonesLoader(getActivity());
    }
